...
@click.option(
    "--input-file-dir",
    type=click.STRING,
    help="The path to the directory with the data files. there needs to be two files: best.ckpt = the model ckpt, config.json = the config file,link provided in script",
    default=None,
)
@click.option(
    "--output-file-dir",
